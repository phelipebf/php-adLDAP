...
class adLDAP {
    ...
    * @param bool optional $UPNLogin Enable support to UPN logon authentication 
    *             method ("username@domainname.com" credentials format) instead 
    *             of Windows authentication method ("username" credentials format)
    * @return bool
    */
